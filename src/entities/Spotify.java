...
<<<<<<< HEAD
	...
	public int getnPlaylist() {
		String[] quantPlaylist = getNomePlaylist();
		return quantPlaylist.length;
	}
	...
	public void preencherDados() {
		for (int i = 0; i < 10; i++) {
			...
			artistas[i] = new Artista("Artista".concat(s), "dataNascimento".concat(s), "email".concat(s),
					"senha".concat(s), "albuns".concat(s), "musicas".concat(s), "seguidores".concat(s),
					"sob".concat(s));
			musicas[i] = new Musica("Musica".concat(s), "artista".concat(s), "duracao".concat(s), "album".concat(s));
			playlist[i] = new Playlist("Playlist".concat(s), "proprietario".concat(s), "duracaoPlaylist".concat(s),
					"musicas".concat(s));
			albuns[i] = new Album("Album".concat(s), "anoLancamento".concat(s), "musicas".concat(s),
